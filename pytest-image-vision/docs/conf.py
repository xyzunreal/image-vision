# -*- coding: utf-8 -*-
#
# pytest-image-vision documentation build configuration file, created by
...
project = u'pytest-image-vision'
copyright = u'2015, Nishchal Gaba'
author = u'Nishchal Gaba'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-image-vision Documentation',
     [author], 1)
]
